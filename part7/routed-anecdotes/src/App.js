...
const Anecdote = ({ anecdote }) => {
  return (
    <div>
      ...
      <div><strong>URL: </strong>{anecdote.info}</div>
...
const App = () => {
  ...
  let timeOutID
  const notificationSet = (content, timer) => {
  ...
  return (
    <div> 
      ...
      <Routes>
        ...
        <Route path="/create" element={<CreateNew addNew={addNew} notificationSet={notificationSet}/>}></Route>
